  ...
  (s.n = (e) => {
    ...
    (() => {
      var e = s(89),
        ...
        i = s(634);
      const c = JSON.parse(
          '["dgxcreators\\\\.in(?:/.*)?/ola/services/.*","dgxcreators\\\\.in/ola/meetings/.*","/api/","https://api\\\\.ola\\\\.godaddy\\\\.com","https://72349a69-6b6c-4b90-9bf7-009c4bd3ba7e\\\\.onlinestore\\\\.godaddy\\\\.com","/t/1/tl/event","google-analytics\\\\.com/collect","calendar\\\\.apps\\\\.(dev-|test-)?secureserver\\\\.net"]'
        ).map((e) => new RegExp(e)),
        o = JSON.parse(
          '["dgxcreators\\\\.in(?:/.*)?/f/.*","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/72349a69-6b6c-4b90-9bf7-009c4bd3ba7e/feed/post/","https://blog\\\\.apps\\\\.secureserver\\\\.net/v1/website/72349a69-6b6c-4b90-9bf7-009c4bd3ba7e/feed"]'
        ).map((e) => new RegExp(e)),
        h = JSON.parse(
          '["/","/team","/about-us","/freelance-oppurtunity","/e-learning-services"]'
        ).map((e) => ({ url: e, revision: "1717593545642" }));
      self.addEventListener("activate", function (e) {
        e.waitUntil(
          caches.keys().then(function (e) {
            return Promise.all(
              e
                .filter((e) => e.startsWith("dgxcreators.in-"))
